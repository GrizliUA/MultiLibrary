...
cursor.execute( "CREATE TABLE IF NOT EXISTS Categories("
                ...
                "category_label VARCHAR(40) NOT NULL UNIQUE,"
...
cursor.execute( "CREATE TABLE IF NOT EXISTS Items ("
                ...
                "item_label VARCHAR(100) NOT NULL UNIQUE,"
                "item_info TEXT,"
                "item_video_link VARCHAR(255),"
                "item_photo_link VARCHAR(255),"
                "item_date year NOT NULL,"
...
mydb.commit()
cursor.execute(
"INSERT INTO Items (item_category_id,item_label,item_info,item_video_link,item_photo_link,"
"item_date,item_value) VALUES"
...
"ngerous_World_Tour_1993.jpg/1200px-Michael_Jackson_Dangerous_World_Tour_1993.jpg',1987,9.9),"
...
"ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8cGhvdG98ZW58MHx8MHx8&w=1000&q=80',2005,6.4),"
...
"s=612x612&w=0&k=20&c=ZGDzFIsXr4-kW7YoEo2blwiM5yqlSU0yOzYgXRRETgQ=',2016,4.2),"
...
"pc2ziPDglQ2FPcV7aEoSWbmSM-bwDwJTPCIFWwItYMQ=',2013,9.3),"
...
"&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8c3VtbWVyJTIwZnVufGVufDB8fDB8fA%3D%3D&w=1000&q=80',2001,7.7),"
...
"7OwCBl_9SZANCKGA&usqp=CAU',1995,8.8),"
...
"-Aid-Queen-Wembley-Stadium-July-13-1985.jpg',1992,8.7);")
mydb.commit()
cursor.close()
